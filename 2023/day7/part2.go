...
// We only need to adjust this and the cardStrengths for part 2, rest stays same
...
func breakTie(hand1 string, hand2 string) string {
	cardStrengths := map[rune]int{'A': 13, 'K': 12, 'Q': 11, 'T': 9, '9': 8, '8': 7, '7': 6, '6': 5, '5': 4, '4': 3, '3': 2, '2': 1, 'J': 0}
